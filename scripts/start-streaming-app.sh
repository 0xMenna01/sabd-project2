...
docker run -d --network project2_network --name flink-app --volume ./src/processing:/opt/flink/job --volume ./Results:/opt/flink/results jobsubmit-app bash -c "flink run -m jobmanager:8081 --python /opt/flink/job/main.py $QUERY_NUM"
